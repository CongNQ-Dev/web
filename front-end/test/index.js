...
scene.add(light);
scene.add(new THREE.AmbientLight(0xffffffff, 0.75));
    ...
    uniforms: {
      ...
      logo: {
        value: new THREE.TextureLoader().load(
          "https://e7.pngegg.com/pngimages/809/78/png-clipart-computer-icons-html-font-others-text-logo.png"
        ),
      },
    },
    vertexShader:
...
var obj = new THREE.Mesh(
  ...
  new THREE.MeshLambertMaterial({ color: 0xeefeff })
);
// scene.add(obj); object thiebn thach
...
// hihi
function main() {
  const canvas = document.getElementById("c"); // <canvas> element from DOM
  ...
  const material = new THREE.MeshPhongMaterial({ color: "#D35400" });
